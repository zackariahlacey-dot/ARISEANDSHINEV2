...
export const GUIDES: Guide[] = [
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "**Interior + Exterior** — $240 to $320. Combined interior + exterior, typically discounted versus booking them separately.",
  ...
  },
  {
    ...
    primaryCta: { label: "Book a Interior + Exterior Detail", href: "/detailing" },
