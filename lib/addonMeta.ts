...
export const ADDON_META: AddonMeta[] = [
  ...
  { id: "salt_stain_removal", label: "Salt Stain Removal & Prevention", side: "interior",
    basePrice: 50, baseDuration: 30 },
  { id: "seat_removal",       label: "Seat Removal — Deepest Clean", side: "interior",
    basePrice: 125, baseDuration: 90 },
  // ── Exterior ───────────────────────────────────────────────────────────
