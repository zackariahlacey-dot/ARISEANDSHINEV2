  ...
  },
  {
    ...
    localFaq: [
      ...
      },
      {
        ...
        a: "Yes. Our Salt Season Recovery and Exterior Detail packages target exactly the kind of buildup that boat-tow trucks accumulate from the bay's launch ramps. Wheel wells, undercarriage spray-down, and salt-neutralizing wash all included.",
      },
    ],
  },
  {
    ...
    localFaq: [
      {
        ...
        a: "Yes — that's exactly what our Salt Season Recovery and Exterior Detail packages are built for. Wheel wells, undercarriage, fender liners, and salt-neutralizing wash all included.",
      },
      {
