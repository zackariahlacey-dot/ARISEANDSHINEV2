    ...
    <>
      ...
      <Section withGrid spacing="large" className="min-h-screen flex items-center pt-32 md:pt-48 overflow-hidden">
        ...
        <div className="text-center relative z-10 w-full">
          ...
          >
            <h1 className="text-6xl md:text-[130px] font-black tracking-tighter text-white mb-8 leading-[0.85] drop-shadow-2xl">
          ...
          >
            ...
            <PrismButton 
              variant="outline" 
              className="w-full sm:w-auto text-lg py-6 px-12 border-white/10 hover:border-white/30"
        ...
        <motion.div 
          ...
          className="absolute top-1/4 right-[15%] w-96 h-96 glass rounded-full blur-3xl opacity-[0.03] pointer-events-none will-change-transform"
        />
        ...
        >
          ...
          <div className="w-[1px] h-12 bg-linear-to-b from-[#fbbf24]/40 to-transparent" />
        </motion.div>
      </Section>
    </>
  );
