...
export default function Services({ onSelectService }: { onSelectService?: (name: string) => void }) {
  ...
  return (
    <Section id="services" spacing="none" className="py-24 md:py-48 bg-[#020202] relative overflow-hidden border-y border-white/5">
      <div className="max-w-7xl mx-auto px-6 md:px-12 mb-32 relative z-10">
        <div className="flex items-center gap-6 mb-8">
          ...
          <span className="text-variable">Service_Manifest</span>
        </div>
        <h2 className="text-6xl md:text-[140px] font-black text-white uppercase tracking-tighter leading-none italic">
          Detailing <br /> <span className="text-transparent bg-clip-text bg-linear-to-b from-white to-white/10">Systems</span>
        </h2>
      </div>
